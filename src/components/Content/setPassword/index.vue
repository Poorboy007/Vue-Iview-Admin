<template>
  <div class="set-password">
    <Poptip transfer trigger="focus" placement="right" width="250">
      <Input v-model="currentValue" type="password" password :maxlength="maxlength" :size="size"
             :placeholder="placeholder"
             :disabled="disabled" :readonly="readonly" @on-change="handleChange" />
      <div slot="content" :class="tipStyle">
